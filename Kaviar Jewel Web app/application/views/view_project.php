...
<body style="background-repeat: no-repeat; background-position: center; background-size: cover; background-image: url('<?php echo base_url(); ?>assets/user_template/images/bg-01.jpg');">
	<div class="limiter" >
		<header > 
			...
			<div style="font-size:18px;font-weight:700;margin-left:130px; color:#9300b8;">View project</div>
            <br>
            <form enctype="multipart/form-data" class="login100-form validate-form" method="post" action="<?php echo base_url();?>Projects/all">
					<div class="wrap-input100 validate-input m-b-23" data-validate="Project name is required">
						...
						<input disabled class="input100" type="text" name="project_name" placeholder="Type your project name" value="<?php foreach($project_data->result() as $row){ echo $row->project_name;}?>">
    			...
    			<div class="text-center p-t-15 p-b-0">
						...
						<div class="container-login100-form-btn">
                            ...
                            <button class="login100-form-btn" style="border-radius:25px 25px; border: 2px solid #7d009c;">
								<span style="color:#7d009c; font-weight:700">	BACK </span>
								</button>
							</div>
						</div>
				</form>
