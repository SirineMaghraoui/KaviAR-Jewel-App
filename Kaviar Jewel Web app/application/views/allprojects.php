		...
		<div class="wrap-login200 p-l-15 p-r-15 p-t-15 p-b-0" style="margin-left:auto; margin-right:auto; width:1200px;">
			...
			?>
		            <tr style="font-size:17px; font-weight:600;">
						...
						<td>
						<?php $this->load->model('project_model');
						echo $this->project_model->getUsernameByIdProject($row->id_project);
						?> 
						</td>
						...
						<td> 
						<a style="color:white;" href="<?php echo base_url();?>Projects/viewProject/<?php echo $row->id_project?>"><button type="button"  style="color:#00A6B7; border:2px solid #00A6B7;background-color:none;margin-right:20px;border-radius:20px; height:40px; width:40px;" class="btn btn-circle mybtn5"><i class="fa fa-folder-open "></i> </button></a>
 	...
 	<div class="child">		
  	...
  	<div class="child">		
		...
		<div class="wrap-login200 p-l-30 p-r-30 p-t-30 p-b-40" style="margin-left:auto; z-index:10; margin-right:auto; width:1200px;">
			...
			?>
				<?php if($search_found==''){?>
								<div class="p-l-20 p-r-20 p-t-20 p-b-20"style="text-align:center;font-size:20px; font-weight:700;"> There are no projects in database. </div> 
			...
			$(document).ready(function(){
				...
				$('.deleteProject').click(function(){
					...
					if(confirm("Are you sure you want to delete this project?")){
						window.location="<?php echo base_url();?>Projects/deleteProject/"+id;
					}else{
						return false;
					}
				})
