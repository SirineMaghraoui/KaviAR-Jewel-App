...
<body style="background-repeat: no-repeat; background-position: center; background-size: cover; background-image: url('<?php echo base_url(); ?>assets/user_template/images/bg-01.jpg');">
	<div class="limiter" >
     ...
     <div class="wrap-login100 p-l-45 p-r-45 p-t-45 p-b-40" style="margin-left:auto;margin-right:auto; width:500px;margin-top:-40px;">
			<div style="font-size:18px;font-weight:700;margin-left:130px; color:#9300b8;">Manage project</div>
            <br>
            <form enctype="multipart/form-data" class="login100-form validate-form " method="post" action="<?php echo base_url();?>Projects/approveProject/<?php foreach($project_data->result() as $row){ echo $row->id_project;}?>">
					<div class="wrap-input100 validate-input m-b-23" data-validate="Project name is required">
						...
						<input disabled class="input100" type="text" name="project_name" value="<?php foreach($project_data->result() as $row){ echo $row->project_name;}?>">
						<span class="focus-input100" data-symbol="&#xf223;"></span>
					</div>

					<div>
						<span class="label-input100"style="font-size:17px;">Type</span>
                        <select style ="margin-left:80px;"name="type_list" disabled>
					...
					<br>
                        <img name="image" id="image" style="object-fit: cover;float:right;margin-top:-70px;"
						src="<?php foreach($project_data->result() as $row){ echo base_url().$row->thumbnail_path;}?>"
						 width="80" height="80">
					</div>
                    <br>
				<div  style=" margin-left:auto; margin-right:auto;border:2px dashed rgb(149, 83, 255);border-color:rgb(149, 83, 255);text-align: center;">
					<div id="upload_zone" class="upload_zone p-t-10 p-b-10"> 
						<span style="font-weight:600;color:rgb(149, 83, 255);">	Upload Asset Bundle</span>
						<input id="mymodel" name="mymodel" type="file" style="text-align: center; margin: auto;">
					</div>	
				</div>
				<br>
					<div class="text-center p-t-15 p-b-0">
						...
						<div class="container-login100-form-btn">
                            ...
                            <button class="login100-form-btn mybtn2"  style="border-radius:25px 25px; border: 2px solid #7d009c;">
									<span style="color:#7d009c; font-weight:700"><i class="fa fa-check"></i>	APPROVE PRJECT <span>
								</button>
							</div>
						</div>						
				</form>
