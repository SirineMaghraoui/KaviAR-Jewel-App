...
<body style="background-repeat: no-repeat; background-position: center; background-size: cover; background-image: url('<?php echo base_url(); ?>assets/user_template/images/bg-01.jpg');">
		...
		<?php
		if($fetch_data_projects->num_rows()>0){	
		?>
		<div class="wrap-login100-form-btn" style="width:20%;margin-top:-20px;">
			<div class="login100-form-bgbtn" style=" background: -webkit-linear-gradient(right, rgba(256,256,256,0.0),rgba(256,256,256,0.45), rgba(256,256,256,0.0), rgba(256,256,256,0.45));">	
			</div>
			<form action="<?php echo base_url();?>Projects/addProject" method="post">
				<button class="login100-form-btn" style="border-radius: 25px 25px;border: 2px solid white;">
					+ ADD NEW PROJECT
				</button>
			</form>
		</div>
		...
		<div class="wrap-login200 p-l-15 p-r-15 p-t-15 p-b-0" style="margin-left:auto; margin-right:auto; width:1000px;">
			<div class="p-l-15 p-r-15 p-t-15 p-b-30 "style="text-align:center;font-size:18px; font-weight:700;" >
				<form action="<?php echo base_url();?>Projects/searchMyProjects" method="post">
				 <div class="row">
					<div class="col-lg-12">
				...
				<br>
				<?php
				if($fetch_data_projects->num_rows()>4){	
				?>
			...
			foreach($fetch_data_projects->result() as $row){
			?>
		            <tr style="font-size:17px; font-weight:600;">
                		...
                		<td>
							...
							<label class="badge badge-warning" style="font-size:100%; font-weight:500;background-color:#00a6b7; color:white;">Approved</label>
							<?php }else if($row->state == 'Pending') {?>
							<label class="badge badge-warning" style="font-size:100%; font-weight:500;background-color:#960096; color:white;">Pending</label>
							<?php }else if($row->state == 'Rejected') {?>
							<label class="badge badge-info" style="font-size:100%; font-weight:500;background-color:#FF4D00; color:white;">Rejected</label>
						<?php	
						}
						?>
						</td>
						<td> 
				 		<a style="color:white;" href="<?php echo base_url();?>Projects/updateProject/<?php echo $row->id_project?>"><button type="button"  class="mybtn4 btn btn-circle" style="color:#133e72; border:2px solid #133e72;background-color:#none;margin-right:20px;border-radius:20px; height:40px; width:40px;" ><i class="fa fa-pencil"></i> </button></a>
				 		<a class="deleteProject" id="<?php echo $row->id_project?>"href="#"><button type="button" class="btn btn-circle mybtn3" style="border:2px solid #C82333;color:#C82333;height:40px; width:40px; margin-left:-10px;border-radius:20px;"><i class="fa fa-trash"></i></button></a>
					</td>
						</tr>
			<?php
			}
		...
		<div class="wrap-login200 p-l-30 p-r-30 p-t-30 p-b-40" style="margin-left:auto; z-index:10; margin-right:auto; width:1000px;">
			...
			?>
		<?php if($search_found==''){?>
        	<div class="wrap-login200 p-l-20 p-r-20 p-t-20 p-b-0" style="margin-left:auto; z-index:10; margin-right:auto;">
				<div class="p-l-20 p-r-20 p-t-20 p-b-30"style="text-align:center;font-size:20px; font-weight:700;"> You don't have any projects. 
				</div>
				<div class="wrap-login100-form-btn" style="width:50%;">
					<div class="login100-form-bgbtn" style=" background: -webkit-linear-gradient(right, rgba(256,256,256,0.0),rgba(125,0,156,0.45), rgba(256,256,256,0.0), rgba(125,0,156,0.45));">	
			</div>
			<form action="<?php echo base_url();?>Projects/addProject" method="post">
				<button class="login100-form-btn" style="border-radius: 25px 25px;border: 2px solid #7D009C;">
				<span style="color:#7D009C;">	+ ADD NEW PROJECT </span>
				</button>
			</form>
				</div>
			</div> 
			...
			$(document).ready(function(){
				...
				$('.deleteProject').click(function(){
					...
					if(confirm("Are you sure you want to delete this project?")){
						window.location="<?php echo base_url();?>Projects/deleteMyProject/"+id;
					}else{
						return false;
					}
				})
